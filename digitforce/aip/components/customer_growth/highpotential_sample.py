...
@mount_data_pv
def repurchase_sample_construct(train, predict, train_date, current_date, predict_date, cate_list, event, image_tag="latest"):
    """
    ...
    :param event: used to define what is the high potential candidates, including purchase, click, collect, cart_add, browse (购买，点击，收藏，加购，浏览）
    :param image_tag:
    :return:
    """
    arguments = ["main.py",
