...
@mount_data_pv
def time_series_backup_test(forecast_start_date,purpose,time_type,predict_model_output, image_tag="latest"):
    '''
    ...
    arguments = ['/data/entrypoint.sh','spark-submit', '--master', 'yarn', '--deploy-mode', 'cluster', '--conf',
                  ...
                  './forecast.zip,digitforce.zip', 'forecast/time_series/runnable/submit_back_test.py',
