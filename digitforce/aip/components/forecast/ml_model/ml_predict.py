...
@mount_data_pv
def ml_model_predict(sdate, edate, image_tag="latest"):
    """
    大单过滤
    ...
    """
    return dsl.ContainerOp(name="ml_model_predict",
                           ...
                           arguments=['spark-submit', '--master', 'yarn', '--deploy-mode', 'cluster', '--conf',
                                      ...
                                      'forecast/ml_predict/runnable/sales_ml_predict.py', str(sdate),
                                      str(edate)])
