...
@mount_data_pv
def sales_continue(sdate, edate,date_type, col_time, col_wm, input_table, output_table, col_qty, image_tag="latest"):
    """
    ...
    return dsl.ContainerOp(name="sales_continue",
                           ...
                           arguments=['spark-submit', '--master', 'yarn', '--deploy-mode', 'cluster', '--conf',
                                      ...
                                      'forecast/data_processing/runnable/sales_continue.py', str(sdate),
                                      str(edate),date_type, col_time, col_wm, input_table, output_table,col_qty])
