...
@mount_data_pv
def build_weather_feature_weekly(sdate, edate, weather_list, col_key, join_key, image_tag="latest"):
    """
    大单过滤
    ...
    """
    return dsl.ContainerOp(name="build_weather_feature_weekly",
                           ...
                           arguments=['/data/entrypoint.sh','spark-submit', '--master', 'yarn', '--deploy-mode', 'cluster', '--conf',
                                      ...
                                      'forecast/feature_processing/runnable/build_weather_feature_weekly.py', str(sdate),
