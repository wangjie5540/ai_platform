...
@mount_data_pv
def build_date_feature_monthly(sdate, edate, col_key, col_time, image_tag="latest"):
    """
    大单过滤
    ...
    """
    return dsl.ContainerOp(name="build_date_feature_monthly",
                           ...
                           arguments=['/data/entrypoint.sh','spark-submit', '--master', 'yarn', '--deploy-mode', 'cluster', '--conf',
                                      ...
                                      'forecast/feature_processing/runnable/build_date_feature_monthly.py', str(sdate),
