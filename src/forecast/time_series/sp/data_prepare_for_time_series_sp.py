...
# from pyspark.sql.functions import max,date_format,to_date,column
from pyspark.sql.functions as psf
from forecast.common.common_helper import *
from forecast.common.data_helper import row_transform_to_dataFrame
...
def data_precess(param,spark):
    ...
    try:
        ...
        df = row_transform_to_dataFrame(data_result)
