...
def ml_predict(key_value, predict_x, predict_len, save_path, param,
               mode_type, back_testing=None):
    """
    模型训练
    ...
    print("model_all type is ", type(model_all))
    print("model_all keys is ", model_all.keys())
