from src.deeplearning.layers.utils import *
from tensorflow.keras.layers import Dense
from src.deeplearning.layers.layer import FMLayer, DNN


def deepfm(inputs, linear_columns_name, dnn_columns_name, hidden_unit=(128, 64, 32), l2_reg=0,
           activation='relu', dropout_rate=0, seed=1024):
    ...
    linear_sparse_value_list, linear_dense_value_list = input_from_feature_columns(keras_input, linear_feature_columns,
    ...
    dnn_logit = Dense(1, activation=None, use_bias=False,
