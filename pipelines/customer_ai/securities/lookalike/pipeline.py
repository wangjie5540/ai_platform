...
def pipeline_func(global_params: str, flag='TRAIN'):
    with dsl.Condition(flag != "PREDICT", name="is_not_predict"):
        raw_user_feature_op = RawUserFeatureOp(name='raw_user_feature', global_params=global_params, tag="2.0.0")
        raw_item_feature_op = RawItemFeatureOp(name='raw_item_feature', global_params=global_params, tag="2.0.0")
        ...
        op_sample_selection = SampleSelectionLookalike(name='sample_select', global_params=global_params, tag="2.0.0")
